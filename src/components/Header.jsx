    ...
    return (
        <div style={{position: "sticky", width: "100%", margin: "0", padding: "10px 0",backdropFilter: "blur(50px)", height: "auto", boxSizing: "border-box", boxShadow: "2px 2px 2px 2px #d2d2d2", zIndex: "1"}}>
                 <div style={{ display: "flex", justifyContent: "space-around"  }}>
                    <div style={{ marginTop: "0" }}><h2><NavLink to="/" style={urlLocation.pathname === "/" ? {color: "#4682B4", textDecoration: "none", borderBottom: "3px solid #4682B4", paddingBottom: "2px"} : {color: "black", textDecoration: "none"}}>Quiznow</NavLink></h2></div>
